  ...
  return (
    <Container>
      ...
      <div className="mt-4 space-y-3">
        ...
        <Card title="Оборудование" desc="Это влияет на автозамены: если чего-то нет — не предлагать." desc="Отметь, что реально есть. Тогда замены будут не фантазией, а по делу.">
          <div className="grid grid-cols-2 gap-2">
        ...
        <Card title="Ограничения" desc="Напиши: плечо, локоть, поясница, колено, приводящие и т.д. — я буду скрывать плохие варианты." desc="Это не диагноз. Просто чтобы не предлагать плохие варианты, если что-то болит.">
          <div className="grid grid-cols-2 gap-2">
